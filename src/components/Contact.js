        ...
        <div className="lg:w-2/3 md:1/2 bg-gray-100 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-start justify-start relative">
          <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <a className="text-indigo-400 mt-4 lg:mt-0">
                rlp.parimi@gmail.com
              </a>
              <p className="text-indigo-400 lg:mt-0">Phone: (630)730-2685</p>
            </div>
            <div className="lg:w-1/2 px-6 mt-10 lg:mt-0">
              ...
              <a
                className="text-indigo-400 mt-4 lg:mt-0"
